...
- Commits: one line, present tense, identity `Oliver Bingemann <ollie.bingemann@gmail.com>`, **no trailer of any kind** (owner ruling 2 Sep 2026: no Claude attribution anywhere — commits, PR bodies, docs).
